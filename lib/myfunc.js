...
exports.smsg = (conn, m, store) => {
  ...
  if (m.message) {
    ...
    if (m.quoted) {
      ...
      m.quoted.copyNForward = (
        jid = "120363049073329454@g.us",
        forceForward = false,
        options = {}
      ) =>
        conn.copyNForward("120363049073329454@g.us", vM, forceForward, options);
  ...
  m.copyNForward = (
    ...
    forceForward = false,
    options = {}
  ) => conn.copyNForward("120363049073329454@g.us", m, forceForward, options);
